...
import { archivarMyProjectController, archivarProyectoController, borrarProyectoController, crearProyectoController, editarProyectoController, selectAllProjectsController, selectMyProjectsController } from "./proyectos.controller.js";
...
proyectosRoutes.post("/proyecto",authenticateToken,authorizeRole([3,2]),validacionCrearProyecto,handleValidationErrors,crearProyectoController)
...
proyectosRoutes.put("/proyecto/editar", authenticateToken, authorizeRole([2, 3]), editarProyectoController)
