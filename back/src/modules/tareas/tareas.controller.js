...
import { actualizarTareaDoneDeveloperService, actualizarTareaDoneService, actualizarTareaEnCursoDeveloperService, actualizarTareaEnCursoService, actualizarTareaInReviewService, crearTareaService, selectTareasService } from "./tareas.services.js"
...
export const selectTareasController= async(req,res)=>{
    ...
    try {
        const {tareas,meta}=await selectTareasService(id,page,limit)
